...
train_data = ImageTxtDataset(
    r"D:\pythonproject\shixun\DAY3\train.txt",
    r"D:\pythonproject\shixun\DAY3\images\train",
    transforms.Compose([
...
test_data = ImageTxtDataset(
    r"D:\pythonproject\shixun\DAY3\val.txt",
    r"D:\pythonproject\shixun\DAY3\images\val",
    transforms.Compose([
        transforms.Resize(224),
        transforms.RandomHorizontalFlip(),
        transforms.ToTensor(),
