...
# 数据集路径
dataset_dir = r'D:\PyCharm Project\HuaQing\dataset\Images'  # 替换为你的数据集路径
train_dir = r'D:\PyCharm Project\HuaQing\dataset\Image2\train'  # 训练集输出路径
val_dir = r'D:\PyCharm Project\HuaQing\dataset\Image2\val'  # 验证集输出路径
